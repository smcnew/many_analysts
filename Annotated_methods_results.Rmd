...
models are fairly robust to small departures in normality (). 
...
In addition to treatment, models included a suite of co-variates
...
with the hypothesis that parents of enlarged broods struggled to care for all nestlings equally. It is difficult to determine, however, whether these results demonstrate that nestlings are competing within the brood. Although the fact 
that having more siblings tended to reduce a nestling's condition and likelihood of fledging, that does not necessarily
